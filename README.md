...
When **Patient** is open on mobile, the Profile/FRICHMOND/Vitals/Labs/Medications/Orders/Photos/Reporting tab row stays sticky just above the bottom nav and still wraps to multiple rows when needed.
