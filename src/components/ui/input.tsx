  ...
  ({ className, type, onKeyDown, ...props }, ref) => {
    ...
    return (
      <input
        type={type}
        className={cn(
          'flex h-10 w-full min-w-0 rounded-lg border border-input bg-white/90 px-3 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:border-action-primary/50 transition-colors disabled:cursor-not-allowed disabled:opacity-50 md:text-sm',
          isDateOrTimeInput &&
